...
/* Host system alias */
#define CONFIG_XENO_HOST_STRING "aarch64-buildroot-linux-gnu"
...
/* config */
#define CONFIG_XENO_VERSION_STRING "3.2.2"
...
#define PACKAGE_STRING "Xenomai 3.2.2"
